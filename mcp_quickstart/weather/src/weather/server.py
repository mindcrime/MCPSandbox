        ...
        types.Tool(
            ...
            inputSchema = {
                ...
                "properties": {
                    "state": {
                        "type":"string",
                        "description":"Two-letter state code (e.g. CA, NC, NY)"
                    }
                }
            }
        )
    ...
    if name == "get-alerts":
        ...
        try:
            ...
            return [
                types.TextContent(
                    type="text",
                    text="Invalid coordinates. Please provide value numbers for longitude and latitude."
                )
            ]
        ...
        return [
            types.TextContent( type="text", text=forecast_text )]
    else:
